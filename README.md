...
2. **Build the Projects**:
   ...
   - Copy the `NetShiftService.exe` to the `NetShiftSetup` directory: `copy D:\Github\NetShift-Public\NetShiftService\bin\Release\NetShiftService.exe D:\Github\NetShift-Public\NetShiftetup\`
