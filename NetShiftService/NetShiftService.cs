...
namespace NetShiftService
{
    ...
    public partial class NetShiftService : ServiceBase, IIPChangerService
    {
        ...
        public NetShiftService()
        {
            InitializeComponent();
            _host = new ServiceHost(this, new Uri("net.pipe://localhost/IPChangerService"));
